...
public class EZSnackBarContentLayout extends LinearLayout implements
        EZBaseTransientSnackBar.ContentViewCallback {
    ...
    public EZSnackBarContentLayout(Context context) {
        this(context, null);
    }

    public EZSnackBarContentLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
